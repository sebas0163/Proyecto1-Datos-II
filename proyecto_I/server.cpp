 ...
 * @file server.cpp
 * @author Karim Oumhar
 * @brief Creacion de un server con socket modificado por Harold Espinoza.
 * @version 1.3
 * @date 16/06/20
 */
...
/** 
 * @brief bwrite funcion encargada de escribir la informacion del usuarion en un archivo json
 */
...
/** 
 * @brief writedata funcion encargada de escribir la informacion del usuarion en un archivo json
 */
